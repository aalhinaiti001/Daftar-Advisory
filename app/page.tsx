...
function Brand(){return <Link className="brand" href="/"><b>C</b><span><em>Calibre</em><small>BY DAFTAR</small></span></Link>}

export default function Calibre(){return <main className="calibre">
  <header><Brand/><nav><a href="#method">Method</a><a href="#deliver">Deliverables</a><a href="#who">Who it&apos;s for</a><a href="#pilot">Pilot</a><a href="#faq">FAQ</a><Link href="/daftar">Daftar</Link><a className="button small" href={email}>Book a call</a></nav><a className="menu" href="#method" aria-label="Open navigation">☰</a></header>
  <section className="hero wrap"><div><Eyebrow>Hiring Decision Diagnostic</Eyebrow><h1>Your hiring decisions are more guesswork than you think.</h1><p className="lead">Calibre replaces subjective candidate evaluation with structured scorecards, a shared reading method, and team calibration — so the same candidate earns the same read, every time.</p><div className="actions"><a className="button" href={email}>Book a diagnostic call</a><a className="text-link" href="#method">See the method →</a></div></div><Scorecard/></section>
  ...
  <section className="cta"><h2>Bring one role to Calibre.</h2><p>A short diagnostic call is enough to see whether your process is measuring the candidate — or the reviewer.</p><a className="button" href={email}>Book a diagnostic call</a></section>
  <footer><Brand/><div><Link href="/daftar">ABOUT DAFTAR</Link><a href="mailto:ahmad@daftaradvisory.com">AHMAD@DAFTARADVISORY.COM</a><span>DAFTARADVISORY.COM</span></div></footer>
  </main>}
