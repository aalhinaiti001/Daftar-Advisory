...
export default function CalibreAr(){return <main className="calibre ar" dir="rtl" lang="ar">
  <header><Brand/><nav><a href="#method">المنهج</a><a href="#deliver">المذكّرة</a><a href="#scope-of-work">النطاق</a><a href="#faq">أسئلة</a><Link href="/ar">دفتر</Link><Link href="/calibre" className="lang" aria-label="English">EN</Link><a className="button small" href="#scope">اطلب حُكمًا</a></nav><a className="menu" href="#method" aria-label="القائمة">☰</a></header>
