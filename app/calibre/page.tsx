...
export default function Calibre(){return <main className="calibre">
  <header><Brand/><nav><a href="#method">Method</a><a href="#deliver">The memo</a><a href="#scope-of-work">Scope</a><a href="#faq">FAQ</a><Link href="/">Daftar</Link><Link href="/ar/calibre" className="lang" aria-label="العربية">ع</Link><a className="button small" href="#scope">Request a Verdict</a></nav><a className="menu" href="#method" aria-label="Open navigation">☰</a></header>
