...
export default function Calibre(){return <main className="calibre">
  <header><Brand/><nav><a href="#method">Method</a><a href="#deliver">Deliverables</a><a href="#who">Who it&apos;s for</a><a href="#pilot">Pilot</a><a href="#faq">FAQ</a><Link href="/">Daftar</Link><a className="button small" href={email}>Book a call</a></nav><a className="menu" href="#method" aria-label="Open navigation">☰</a></header>
